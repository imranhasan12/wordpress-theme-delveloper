...
<head>
    ...
    <title>Aseem - HTML Template</title>
...
<body>
    ...
    <section class="section-padding bg-light portfolio-area">
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsam dolor sint, culpa consequatur excepturi repellat!</p>
                    </div>
                </div>
            </div>
            <!-- // section title -->
            ...
            <div class="row">
                <!-- Single Portfolio -->
                <div class="col-lg-4 mix consulting seo">
                ...
                <!-- Single Portfolio -->
                <div class="col-lg-4 mix consulting">
                ...
                <!-- Single Portfolio -->
                <div class="col-lg-4 mix seo marketing">
                ...
                <!-- Single Portfolio -->
                <div class="col-lg-4 mix consulting marketing">
                ...
                <!-- Single Portfolio -->
                <div class="col-lg-4 mix consulting seo marketing">
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="inner-promo">
                        ...
                        <a href="#" class="bttn-md-light">Join Now</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Footer Area -->
    <footer class="footer-area section-padding" style="background-image: url(assets/img/footer-map.png);">
        <div class="container">
            <div class="row">
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <p class="copyright-text">&copy; 2019 All Rights Reserved | Design by <a href="https://www.begindot.com/">BeginDot</a></p>
                </div>
